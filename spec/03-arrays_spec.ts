...
describe('array methods', () => {
    ...
    it('forEach allow you to look at each member', () => {
    ...
    describe('methods that produce a new array', () => {
        it('selecting just specific stuff from an array', () => {
            ...
            expect(numbers).toEqual([1, 2, 3, 4, 5, 6, 7, 8, 9]); //just showing you this so you see it doesnt change the array
        });
        ...
        it('a quick practice', () => {
            ...
            const result = vehicles //all of the vehilces
